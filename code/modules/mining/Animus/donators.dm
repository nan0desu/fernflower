...
/datum/donators/proc/donatorpanel()
	...
	dat += "<b>Gloves:</b> <br>"
	dat += "White: <A href='?src=\ref[src];item=/obj/item/clothing/gloves/white;cost=350'>350</A><br>"
	dat += "Rainbow: <A href='?src=\ref[src];item=/obj/item/clothing/gloves/rainbow;cost=350'>350</A><br>"
	dat += "Fingerless: <A href='?src=\ref[src];item=/obj/item/clothing/gloves/fingerless/black;cost=350'>350</A><br>"
	dat += "Fingerless: <A href='?src=\ref[src];item=item=/obj/item/clothing/gloves/black;cost=400'>400</A><br>"
	dat += "<b>Coats:</b> <br>"
