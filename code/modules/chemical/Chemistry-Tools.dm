					...
					if(D)
						for(var/mob/living/carbon/M in D.loc)
							...
							if (istype(M, /mob))
								...
								message_admins("ATTACK: [user] ([user.ckey])(<A HREF='?src=\ref[usr.client.holder];adminplayerobservejump=\ref[user]'>JMP</A>) shot [M] ([M.ckey]) with a syringegun ([R]).")
							else
								...
								message_admins("ATTACK: UNKNOWN shot [M] ([M.ckey])(<A HREF='?src=\ref[usr.client.holder];adminplayerobservejump=\ref[M]'>JMP</A>) with a <b>syringegun</b> ([R]).")
...
/obj/item/weapon/reagent_containers/hypospray/attack(mob/M as mob, mob/user as mob)
	...
	if (reagents.total_volume)
		...
		message_admins("ATTACK: [user] ([user.ckey](<A HREF='?src=\ref[usr.client.holder];adminplayerobservejump=\ref[user]'>JMP</A>) injected [M] ([M.ckey]) with [src].")
		...
		if(istype(M, /mob/living/carbon))
			if(M == user)								//If you're eating it yourself.
				...
				if(!istype(M, /mob/living/carbon/metroid))		//If you're feeding it to someone else.
					...
					message_admins("ATTACK: [user] ([user.ckey])(<A HREF='?src=\ref[usr.client.holder];adminplayerobservejump=\ref[user]'>JMP</A>) fed [M] ([M.ckey]) with [src].")
