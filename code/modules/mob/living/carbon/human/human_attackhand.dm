		...
		if(G.cell)
			if(M.a_intent == "hurt")//Stungloves. Any contact will stun the alien.
				if(G.cell.charge >= 2500)
					...
					message_admins("ATTACK: [src] ([src.ckey])(<A HREF='?src=\ref[src];adminplayerobservejump=\ref[src]'>JMP</A>) stungloved [M] ([M.ckey]).")
...
//			if(M.health < -75)	return 0
		...
		if("hurt")
			...
			if(ELECTRICHANDS in M.augmentations)
				...
				message_admins("ATTACK: [M.name] ([M.ckey])(<A HREF='?src=\ref[src];adminplayerobservejump=\ref[M]'>JMP</A>) used Electric Hands nanoaug on [src.name] ([src.ckey]), shocking them .")
			...
			if(M.type != /mob/living/carbon/human/tajaran)
				...
				message_admins("ATTACK: [M] ([M.ckey])(<A HREF='?src=\ref[src];adminplayerobservejump=\ref[M]'>JMP</A>) punched [src] ([src.ckey]).")
				...
				message_admins("ATTACK: [M] ([M.ckey])(<A HREF='?src=\ref[src];adminplayerobservejump=\ref[M]'>JMP</A>) slashed [src] ([src.ckey]).")
